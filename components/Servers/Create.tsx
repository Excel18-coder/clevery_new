...
const Create = (
{
  ...
  return (
    <KeyboardAvoidingView behavior='position' className='pb-3' >
      ...
      {type === "server" &&
        ...
        <View className='flex-row flex-wrap' >
          ...
          >
            <Feather name='user-plus' size={24} className='bg-gray-400 rounded-lg p-2' />
          </TouchableOpacity>
        </View>
      </View>
      }
      <TouchableOpacity className='w-20 h-9 bg-blue-500 justify-center px-1 rounded-lg mb-3'  onPress={handleSubmit} >
