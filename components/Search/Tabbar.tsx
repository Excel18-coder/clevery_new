    ...
    <View className='py-1 px-2 border-b border-gray-500'>
      <View className='flex-row justify-between'>
        ...
        >
          ...
          <Text className={`text-sm mt-1 text-[#666] border-b-[3px] ${selected === 'recents' && 'border-b-light' }`}>Recents</Text>
        </TouchableOpacity>
        <TouchableOpacity
        ...
        >
          ...
          <Text className={`text-sm mt-1 text-[#666] border-b-[3px] ${selected === 'people' && 'border-b-light' }`}>People</Text>
        </TouchableOpacity>
        <TouchableOpacity
        ...
        >
          ...
          <Text className={`text-sm mt-1 text-[#666] border-b-[3px] ${selected === 'media-links' && 'border-b-light'}`}>Media Links</Text>
        </TouchableOpacity>
        <TouchableOpacity
        ...
        >
          ...
          <Text className={`text-sm mt-1 text-[#666] border-b-[3px] ${selected === 'files' && 'border-b-light' }`}>Files</Text>
        </TouchableOpacity>
      </View>
    </View>
  );
